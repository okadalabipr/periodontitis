...
class ParameterSensitivity(ExecModel, SignalingMetric):
    ...
    def _barplot_sensitivity(
        ...
        for k, obs_name in enumerate(self.model.observables):
            ...
            plt.axvspan(3.63, 5.63, color = "silver")
            plt.axvspan(9.63, 10.63, color = "silver")
            plt.axvspan(17.63, 22.63, color = "silver")
            plt.axvspan(26.63, 28.63, color = "silver")
            plt.axvspan(29.63, 33, color = "silver")
            for l, condition in enumerate(self.model.problem.conditions):
                #sensitivity_matrix = sensitivity_coefficients[:, :, 0, l]
            ...
            plt.xticks(
                ...
                #["1","2","3","4","27","28","5","10","11","32","7","6","12","13","19","18","29","33","14","15","16","17","30","9","20","21","31","8","22","25","24","23","26"],
                #fontsize=6,
                fontsize=10,
                #rotation=90,
            )
